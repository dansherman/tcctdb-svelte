...
<div class="min-h-full">
  ...
  <div class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col lg:border-r lg:border-gray-200 lg:bg-gray-100 lg:pt-5 lg:pb-4">
    ...
    <div class="mt-5 flex h-0 flex-1 flex-col overflow-y-auto pt-1">
      ...
      <div class="relative inline-block px-3 text-left">
        ...
        -->
        <div class="absolute right-0 left-0 z-10 mx-3 mt-1 origin-top divide-y divide-gray-200 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="options-menu-button" tabindex="-1">
  ...
  <div class="flex flex-col lg:pl-64">
	...
	<footer>
		<div class="w-full py-4 text-center">Provided by <a href="https://4communitytheatre.org">4 Community Theatre</a> with content hosting by <a href="https://sanity.io">Sanity.io</a>.</div>
	</footer>
