                ...
                <li>
                  <div class="flex items-center px-4 py-4 sm:px-6">
                    <div class="min-w-0 flex-1 flex items-center">
                      ...
                      <div class="min-w-0 flex-1 px-4 text-3xl font-medium ">Character</div>
                      <div class="flex-shrink-0 h-12 w-12">&nbsp;</div>
                      <div class="min-w-0 flex-1 px-4 ">
                        <div>
                          <p class="text-3xl font-mediunm truncate">Actor</p>
                        </div>
                      </div>
    ...
    -->
      ...
      >
        <div>
          ...
          <div>
            <label for="comment" class="block text-sm font-medium text-gray-700"
              >Really delete <span class="bg-yellow-200">{roleToDelete['characterName']}</span>?</label
            >
          </div>
        </div>
        <div class="mt-4 flex justify-between">
